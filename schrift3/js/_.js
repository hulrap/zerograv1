...
window.addEventListener('load', function() {
    ...
    class Effect {
        constructor(context, canvasWidth, canvasHeight) {
            ...
            this.maxTextWidth = canvasWidth * .5;
            this.fontSize = Math.min(canvasWidth, canvasHeight) / 15;
            this.lineHeight = .8*this.fontSize;
    ...
    function animate() {
        let skateboardWidth = canvas.width*.75;
        let skateboardHeight = skateboardWidth*.45;
        let skateboardX = canvas.width / 2 - skateboardWidth / 2;
