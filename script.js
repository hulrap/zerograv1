const contractAddress = "0x9A7BBd1Ca16Ee824f11978356321d298A03dDfb1";
const mintPrice = ethers.utils.parseEther("0.075").toString();
...
const BASE_SEPOLIA_CHAIN_ID = '0x14a34'; // Chain ID für Base Sepolia
const BASE_SEPOLIA_RPC_URL = 'https://base-sepolia-rpc.publicnode.com';
const BASE_blockExplorerUrl = "https://sepolia-explorer.base.org"
const BASE_chainName = 'Base Sepolia Testnet'
let ethersProvider;
...
async function checkNetwork() {
    ...
    if (network.chainId !== parseInt(BASE_SEPOLIA_CHAIN_ID, 16)) {
        console.log('Not connected to Base Sepolia L2');
        document.getElementById('networkStatus').textContent = 'Wrong Network';
        //document.getElementById('networkButton').disabled = false; // Aktivieren des Netzwerkwechsel-Buttons
        switchNetwork()
    } else {
        console.log('Connected to Base Sepolia L2');
        document.getElementById('networkStatus').textContent = 'Connected to Base Sepolia';
